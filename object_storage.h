...
{
public:
    ObjectStorage(const std::string &doc_arg,
                  std::map<size_t, size_t> &&id2offsets_arg,
...
private:
    ...
    void insert_obj_stream(size_t id, const std::map<std::string, std::pair<std::string, pdf_object_t>> &encrypt_data);
    std::vector<std::pair<size_t, size_t>> get_id2offsets_obj_stm(const std::string &content,
                                                                  const std::map<std::string,
                                                                                 std::pair<std::string,
                                                                                           pdf_object_t>> &dictionary);
private:

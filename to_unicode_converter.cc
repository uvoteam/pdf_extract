...
ToUnicodeConverter::ToUnicodeConverter(const cmap_t *custom_encoding_arg) noexcept : custom_encoding(custom_encoding_arg)
{
}

ToUnicodeConverter::ToUnicodeConverter() noexcept : custom_encoding(nullptr)
{
}

bool ToUnicodeConverter::is_empty() const
{
    return custom_encoding == nullptr;
}
